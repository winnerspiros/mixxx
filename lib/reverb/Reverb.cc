...
#define L(i) ((int)(l[i] * fs))
    static float l[] = {
            0.004771345048889486, 0.0035953092974026408, 0.01273478713752898, 0.0093074829474816042, 0.022579886428547427, 0.030509727495715868, 0.14962534861059779, 0.060481838647894894, 0.12499579987231611, 0.14169550754342933, 0.089244313027116023, 0.10628003091293972};
...
#define T(i) ((int)(t[i] * fs))
    static float t[] = {
            0.0089378717113000241, 0.099929437854910791, 0.064278754074123853, 0.067067638856221232, 0.066866032727394914, 0.006283391015086859, 0.01186116057928161, 0.12187090487550822, 0.041262054366452743, 0.089815530392123921, 0.070931756325392295, 0.011256342192802662};
...
void PlateStub::process(sample_t x, sample_t decay, sample_t* _xl, sample_t* _xr) {
...
void MixxxPlateX2::processBuffer(const sample_t* in, sample_t* out, const uint frames, const sample_t bandwidthParam, const sample_t decayParam, const sample_t dampingParam, const sample_t currentSend, const sample_t previousSend) {
    // set bandwidth
