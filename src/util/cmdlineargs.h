...
class CmdlineArgs : public mixxx::Singleton<CmdlineArgs> {
  public:
    ...
    bool getStartAutoDJ() const { return m_startAutoDJ; }
    bool getRescanLibrary() const { return m_rescanLibrary; }
    ...
    bool getUseLegacyVuMeter() const { return m_useLegacyVuMeter; }
    bool getUseLegacySpinny() const { return m_useLegacySpinny; }
    bool getControllerDebug() const { return m_controllerDebug; }
    bool getControllerPreviewScreens() const { return m_controllerPreviewScreens; }
    bool getControllerAbortOnWarning() const { return m_controllerAbortOnWarning; }
    ...
    const QStringList& getMusicFiles() const { return m_musicFiles; }
    mixxx::LogLevel getLogLevel() const { return m_logLevel; }
    mixxx::LogLevel getLogFlushLevel() const { return m_logFlushLevel; }
    qint64 getLogMaxFileSize() const { return m_logMaxFileSize; }
    const QString& getStyleName() const { return m_styleName; }
