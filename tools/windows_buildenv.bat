...
:COMMAND_setup
    ...
    IF DEFINED GITHUB_ENV (
        SET "FORWARD_MIXXX_VCPKG_ROOT=!MIXXX_VCPKG_ROOT:\=/!"
        SET "FORWARD_CMAKE_PREFIX_PATH=!CMAKE_PREFIX_PATH:\=/!"
        SET "VCPKG_INSTALLED_DIR=!MIXXX_VCPKG_ROOT!\installed"
        SET "FORWARD_VCPKG_INSTALLED_DIR=!VCPKG_INSTALLED_DIR:\=/!"
        SET "FORWARD_BUILDENV_BASEPATH=!BUILDENV_BASEPATH:\=/!"

        ECHO MIXXX_VCPKG_ROOT=!FORWARD_MIXXX_VCPKG_ROOT!>>!GITHUB_ENV!
        ECHO CMAKE_GENERATOR=!CMAKE_GENERATOR!>>!GITHUB_ENV!
        ECHO VCPKG_TARGET_TRIPLET=!VCPKG_TARGET_TRIPLET!>>!GITHUB_ENV!
        ECHO CMAKE_PREFIX_PATH=!FORWARD_CMAKE_PREFIX_PATH!>>!GITHUB_ENV!
        ECHO VCPKG_INSTALLED_DIR=!FORWARD_VCPKG_INSTALLED_DIR!>>!GITHUB_ENV!
        ECHO BUILDENV_BASEPATH=!FORWARD_BUILDENV_BASEPATH!>>!GITHUB_ENV!
